...
public class TaskService {
    ...
    private final TaskRepository productRepository;
    ...
    public ResponseEntity<Object> createProduct(Task product) {
        Optional<Task> existingProduct = productRepository.findProductsByName(product.getName());
        ...
        if (existingProduct.isPresent()) {
            ...
            Task savedProduct = productRepository.save(product);
    ...
    public ResponseEntity<Object> updateProduct(Task product) {
        Optional<Task> existingProduct = productRepository.findById(product.getId());
